    ...
    <div className="pb-4 lg:mb-36">
        <div className="flex flex-wrap lg:flex-row-reverse">
           ...
           <div className="flex justify-center lg:p-8">
            <motion.img src={profile} alt="Souraj Photo" className="border border-stone-900 rounded-3xl"
            height={650}
            width={650}
           ...
           <div className="w-full lg:w-1/2">
              ...
              className="flex flex-col items-center lg:items-start mt-10">
                ...
                className="pb-2 text-4xl tracking-tighter lg:text-8xl">Souraj Rai</motion.h2>
                <motion.span 
                variants={childvariant}
                ...
                className="my-2 max-w-lg py-6 text-xl leading-relaxed
                 ...
                 <motion.a
                 variants={childvariant} href="/Resume.pdf"
                 target="_blank"
